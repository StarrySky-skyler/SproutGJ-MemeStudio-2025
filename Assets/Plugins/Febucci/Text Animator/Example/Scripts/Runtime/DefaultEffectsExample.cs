...
namespace Febucci.UI.Examples
{
    ...
    public class DefaultEffectsExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            string builtText =
                "<b>You can add effects by using <color=red>rich text tags</color>.</b>" +
            ...
            foreach (var effect in typewriter.TextAnimator.DatabaseBehaviors
                         .Data)
            {
                if (!effect) continue;
            ...
            foreach (var effect in typewriter.TextAnimator.DatabaseAppearances
                         .Data)
            {
                if (!effect) continue;
        ...
        private string AddEffect<T>(TextAnimatorSettings.Category<T> category,
            string tag) where T : ScriptableObject
        {
            return
