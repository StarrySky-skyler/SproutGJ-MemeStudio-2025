...
{
    [Preserve]
    [CreateAssetMenu(menuName = "Text Animator/Animations/Behaviors/Size",
        fileName = "Size Behavior")]
    ...
    public sealed class SizeBehavior : BehaviorScriptableBase
    {
        ...
        public override void SetModifier(ModifierInfo modifier)
        {
            ...
            {
                case "a":
                    amplitude = baseAmplitude * modifier.value * -1 + 1; break;
            ...
            TAnimCore animator)
        {
            character.current.positions.LerpUnclamped(
                ...
                (Mathf.Cos(animator.time.timeSinceStart * frequency +
                           character.index * waveSize) + 1) / 2f * amplitude);
        }
    }
}
