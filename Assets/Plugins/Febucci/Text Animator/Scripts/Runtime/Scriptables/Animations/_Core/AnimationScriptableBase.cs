...
namespace Febucci.UI.Effects
{
    ...
    /// </summary>
    public abstract class AnimationScriptableBase : ScriptableObject,
        ITagProvider
    {
        ...
        public string TagID
        {
            get => tagID;
            set => tagID =
                value; //TODO if playing, discard rebuild if already initialized
        }
        ...
        public abstract bool CanApplyEffectTo(CharacterData character,
            TAnimCore animator);

        public abstract void ApplyEffectTo(ref CharacterData character,
            TAnimCore animator);
    }
}
