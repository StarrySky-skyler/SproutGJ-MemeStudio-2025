...
namespace Febucci.UI.Effects
{
    ...
    public sealed class VerticalExpandAppearance : AppearanceScriptableBase
    {
            ...
            TAnimCore animator)
        {
            ...
            character.current.positions[targetA] = Vector3.LerpUnclamped(
                character.current.positions[startA],
                character.current.positions[targetA], pct);
            character.current.positions[targetB] = Vector3.LerpUnclamped(
                character.current.positions[startB],
