...
namespace Febucci.UI.Core.Parsing
{
    public class TMPTagParser : TagParserBase
    {
        ...
        private static readonly TMPTagInfo[] lookups =
        {
            ...
            new TMPTagInfo("<margin="), new TMPTagInfo("</margin>"),
            new TMPTagInfo("<margin-left>"), new TMPTagInfo("<margin-right>"),
        ...
        public TMPTagParser(bool richTagsEnabled, char openingBracket,
            char closingBracket, char closingTagSymbol)
            ...
            StringBuilder finalTextBuilder, int internalOrder)
        {
            ...
            string fullTag =
                startSymbol + textInsideBrackets + endSymbol; //TODO improve

            foreach (var lookupTag in lookups)
                if (fullTag.StartsWith(lookupTag.tagOpening, true,
        ...
        private struct TMPTagInfo
        {
            ...
            public TMPTagInfo(string tagOpening,
                bool increasesTextLength = false)
            {
