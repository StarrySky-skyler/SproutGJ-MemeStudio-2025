...
namespace Febucci.UI.Core.Parsing
{
    ...
    public class StylesParser : TagParserBase
    {
        ...
        private readonly StyleSheetScriptable sheet;

        //--- CONSTRUCTORS ---
        public StylesParser(char startSymbol, char closingSymbol,
            char endSymbol, StyleSheetScriptable sheet) : base(startSymbol,
            closingSymbol, endSymbol)
        {
            this.sheet = sheet;
            ...
            StringBuilder finalTextBuilder, int internalOrder)
        {
            ...
            textInsideBrackets =
                textInsideBrackets.ToLower(); //styles are case insensitive
